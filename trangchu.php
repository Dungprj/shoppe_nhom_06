            ...
            <ul class="image-carousel__item-list">
              ...
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/phone.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Điện Thoại & Phụ Kiện</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/thiet_bi_dien_tu.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Thiết Bị Điện Tử</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/may_tinh_lap_top.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Máy Tính & Laptop</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/may_anh.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Máy Ảnh & Máy Quay Phim</div>
                    </div>
                  </div>
                </a>
              </li>
              ...
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/dong_ho.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Đồng Hồ</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/giay_dep.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Giày Dép Nam</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    ...
                    <div class="image_txt">
                      <div class="edit_text">Thiết Bị Điện Gia Dụng</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/the_thao.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Thể Thao & Du Lịch</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/o_to_xe_may.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Ô Tô & Xe Máy & Xe Đạp</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/ba_lo.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Balo & Túi Ví Nam</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/do_choi.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Đồ Chơi</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/cham_soc_thu_cung.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Chăm Sóc Thú Cưng</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/dung_cu.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">
              ...
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/thoi_trang_nu.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Thời Trang Nữ</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/me_va_be.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Mẹ & Bé</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/nha_cua_doi_song.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Nhà Cửa & Đời Sống</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/sac_dep.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Sắc Đẹp</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    ...
                    <div class="image_txt">
                      <div class="edit_text">Sức Khỏe</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/giay_dep_nu.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Giày Dép Nữ</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/tui_vi_nu.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Túi Ví Nữ</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/phu_kien_va_trang_suc.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Phụ Kiện & Trang Sức Nữ</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/bach_hoa_online.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Bách Hóa Online</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/nha_sach_online.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Nhà Sách Online</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/thoi_trang_tre_em.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Thời Trang Trẻ Em</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/giat_giu.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Giặt Giũ & Chăm Sóc Nhà Cửa</div>
                    </div>
                  </div>
                </a>
              </li>
              <li class="image-carousel__item">
                <a class="bl_a_item" href="">
                  <div class="block_item">
                    <div class="bl_image">
                      <img class="edit_image" src="./img/voucher.png" alt="" />
                    </div>
                    <div class="image_txt">
                      <div class="edit_text">Voucher & Dịch Vụ</div>
                    </div>
                  </div>
                </a>
              </li>
            ...
            <ul class="image-carousel__item-list image-carousel__item-list_flash_sale">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh12.png" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh5.jfif" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh6.jfif" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh7.jfif" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh8.jfif" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh9.jfif" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh10.jfif" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh11.jfif" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh13.jfif" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh14.jfif" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh15.png" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh16.jfif" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
              ...
              <li class="image-carousel__item image-carousel__item_flash_sale">
                <a class="bl_a_item" href="">
                  <div class="block_item block_item_flash_sale">
                    <div class="bl_image">
                      <img class="edit_image edit_image_flash_sale" src="./img_flash_sale/hinh17.jfif" alt="">
                    </div>
                    <div class="image_txt image_txt_price">
                      <div class="edit_text edit_text_flash_sale">đ 24.300</div>
                      <div class="bl_status_sell">
