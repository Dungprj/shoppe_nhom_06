...
if (isset($_POST["btn_save_pass_new"]))
{
    ...
    <div class="block_left_thongtin">
      ...
      <div class="block_right_thongtin">
        <div class="header_thongtin">
          <div class="txt_1_header_thongtin">Change Password</div>
          <div  class="txt_2_header_thongtin">For your account's security, do not share your password with anyone else</div>
          
          

        </div>

        <div class="bl-form-change-password-thongtin">
          <div class="bl-form-profile-changepassword-thongtin">
            <form action="" method="post" class="bl-form-change-password-thongtin">
              <div class="bl-newpass-confirm-thongtin">
              <div class="bl-password-thongtin">
                  <p class="txt-newpassword-changepassword">Mật khẩu cũ</p>
                  <input type="text" class="form-control input-newpassword" name="old_pass">
                </div>
                <div class="bl-password-thongtin">
                  <p class="txt-newpassword-changepassword">Mật khẩu mới</p>
                  <input type="text" class="form-control input-newpassword" name="new_pass">
                </div>
                <div class="bl-confirm-password-thongtin">
                  <p class="txt-newpassword-changepassword">Nhập lại mật khẩu</p>
                  <input type="text" class="form-control input-newpassword" name="new_pass_repeat">
                </div>
                <div class="btn-confirm-changepassword-thongtin">
                  <button type="submit" class="btn btn-danger btn-confirm-changepassword" name="btn_save_pass_new">Lưu</button>
