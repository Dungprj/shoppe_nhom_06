...
if(isset($_POST["dongydathang"]) && isset($_SESSION["cart"])&&sizeof($_SESSION["cart"]) > 0 )
    ...
    // end lay thong tin dia chi nhan hang
    
 
    $pttt = 0;
    $total =  tongdonhang($_SESSION["cart"]);


    //insert don hang - tao don hang moi
    $idbill = taodonhang($name,$address,$tel,$total,$pttt);
    ...
    //show confirm don hang vua tao

        $ttkh = '<h1 style="font-size:30px;">Bạn đã đặt hàng thành công</h1>
        <br>
            ...
            <div class="form-group">
                ...
                <label>Họ tên</label>
                <input type="text" class="form-control" aria-describedby="emailHelp" name="hoten" value="' . $name . '" readonly>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Địa chỉ</label>
                <input type="text" class="form-control" name="diachi" value="' . $address . '" readonly>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Điện thoại</label>
                <input type="text" class="form-control" name="dienthoai" value="' . $tel . '" readonly>
            </div>
            ';


        $ttgh = showcart($_SESSION['cart'],1);
...
<div class="container bl_bill" style="margin-top:3%;">
<a class="btn btn-danger" href="./trangchu.php" role="button">Về trang chủ</a><br>
