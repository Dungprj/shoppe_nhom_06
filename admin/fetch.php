...
if(isset($_GET["task"]) && $_GET["task"] == "delete") {
  ...
  if(mysqli_query($conn, $sql_delete)) {
    echo "Xoa thanh cong";
    header("location:manage_cate_ajax.php");
  } else {
...
{
  $query .= '
  WHERE catename LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" 
  ';
}
  ...
  foreach($result as $row)
  {
    ...
    <tr>
      ...
      <td>
        ...
        <a class="btn btn-danger" href="fetch.php?task=delete&id='.$row["id"].'"> Xóa</a>
      </td>
    </tr>
    ';
  }
...
if(isset($page_array) && is_array($page_array)) {
