...
<head>
  ...
  <link rel="stylesheet" href="./css/trang_chu_viewcart.css">
...
<body>
  <div class="fluid-container">
    <!-- Header -->
    <div class="fluid-container header" style="height:60px">
  ...
  height: 130px;">
      ...
      <div class="container header-find" style="display:none;">
      ...
      <div class=" header-items" style="display:none;" >
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <form class="form_bill" action="bill.php" method="post" style="    margin-bottom: 5%;margin-top: 3%;">
            <div class="form-group">
                <h2 for="exampleFormControlSelect1">Địa Chỉ</h2>
                <select class="form-control" id="exampleFormControlSelect1" name="address_user_dathang">
                <?php
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<option value=".$row["id"].">" . $row["name"] . "|" . $row["phone"] . "|" . $row["address"] . "</option>";
                        }
                    }
            ...
            <?php
                    ...
                    <div class="bl_dathang_xoacart" style=" width: 100%;
    display: flex;
    height: 5%;
    justify-content: end;">
                        <button class="btn_tieptucdathang btn btn-light" type="button" style="margin-left: 3%;"><a href="./trangchu.php">Tiếp tục đặt hàng</a></button>
                        <button class="btn_xoagiohang btn btn-light" type="button" style="margin-left: 3%;"><a href="./delcart.php"  >Xóa toàn bộ đơn hàng</a></button>
                        <button class="btn_muahang btn btn-danger" type="submit" name="dongydathang" style="margin-left: 3%;">Mua hàng</button>
                    </div>
        ...
        if(!isset($_SESSION["cart"]))
        {
            echo "ban chua dat hang . Ban <a href='./trangchu.php'>Đặt hàng </a> đi";
        }
        ?>
    </div>
